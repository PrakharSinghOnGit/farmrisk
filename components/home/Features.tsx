...
const featuresTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    customizableDesc: "100% customizable climate risk assessment dashboards tailored for FPOs.",
    secureByDefault: "Secure by default",
    secureByDefaultDesc: "All farmer data and location telemetry are end-to-end encrypted.",
    fasterThanLight: "Faster than light",
    fasterThanLightDesc: "Interactive spatial maps and rainfall predictions loaded instantly.",
    keepLovedOnesSafe: "Keep your loved ones safe",
    keepLovedOnesSafeDesc: "Get weather warnings and lightning alerts dispatched in local languages.",
  },
  hi: {
    customizable: "अनुकूलन योग्य",
    customizableDesc: "एफपीओ (FPOs) के लिए अनुकूलित 100% अनुकूलन योग्य जलवायु जोखिम मूल्यांकन डैशबोर्ड।",
    secureByDefault: "सुरक्षित डिफ़ॉल्ट",
    secureByDefaultDesc: "सभी किसान डेटा और स्थान टेलीमेट्री शुरू से अंत तक एन्क्रिप्टेड हैं।",
    fasterThanLight: "प्रकाश से भी तेज",
    fasterThanLightDesc: "इंटरैक्टिव स्थानिक मानचित्र और वर्षा पूर्वानुमान तुरंत लोड होते हैं।",
    keepLovedOnesSafe: "अपने प्रियजनों को सुरक्षित रखें",
    keepLovedOnesSafeDesc: "स्थानीय भाषाओं में मौसम की चेतावनी और बिजली गिरने की चेतावनी प्राप्त करें।",
  },
  mr: {
    customizable: "सानुकूल करण्यायोग्य",
    customizableDesc: "FPOs साठी सानुकूलित केलेले १००% सानुकूल हवामान जोखीम मूल्यांकन डॅशबोर्ड.",
    secureByDefault: "सुरक्षित डीफॉल्ट",
    secureByDefaultDesc: "सर्व शेतकरी डेटा आणि स्थान टेलीमेट्री एंड-टू-एंड एनक्रिप्टेड आहेत.",
    fasterThanLight: "प्रकाशापेक्षा वेगवान",
    fasterThanLightDesc: "परस्परसंवादी नकाशे आणि पावसाचे अंदाज त्वरित लोड होतात.",
    keepLovedOnesSafe: "तुमच्या प्रियजनांना सुरक्षित ठेवा",
    keepLovedOnesSafeDesc: "स्थानिक भाषांमध्ये हवामानाचे इशारे आणि विजेच्या कडकडाटाचे इशारे मिळवा.",
  },
  ta: {
    customizable: "தனிப்பயனாக்கக்கூடியது",
    customizableDesc: "FPOகளுக்கு ஏற்ப 100% தனிப்பயனாக்கக்கூடிய காலநிலை ஆபத்து மதிப்பீட்டு டாஷ்போர்டுகள்.",
    secureByDefault: "பாதுகாப்பானது",
    secureByDefaultDesc: "அனைத்து விவசாயி தரவு மற்றும் இருப்பிட டெலிமெட்ரியும் பாதுகாப்பாக குறியாக்கம் செய்யப்பட்டுள்ளன.",
    fasterThanLight: "ஒளியை விட வேகமானது",
    fasterThanLightDesc: "ஊடாடும் இடஞ்சார்ந்த வரைபடங்கள் மற்றும் மழை முன்னறிவிப்புகள் உடனடியாக ஏற்றப்படும்.",
    keepLovedOnesSafe: "உங்கள் அன்புகுரியவர்களைப் பாதுகாக்கவும்",
    keepLovedOnesSafeDesc: "உள்ளூர் மொழிகளில் வானிலை எச்சரிக்கைகள் மற்றும் மின்னல் விழிப்பூட்டல்களைப் பெறுங்கள்.",
  },
  gu: {
    customizable: "કસ્ટમાઇઝ કરી શકાય તેવું",
    customizableDesc: "FPOs માટે તૈયાર કરાયેલ 100% કસ્ટમાઇઝ કરી શકાય તેવું આબોહવા જોખમ મૂલ્યાંકન ડેશબોર્ડ.",
    secureByDefault: "ડિફૉલ્ટ રૂપે સુરક્ષિત",
    secureByDefaultDesc: "તમામ ખેડૂત ડેટા અને સ્થાન ટેલિમેટ્રી એન્ડ-ટુ-એન્ડ એન્ક્રિપ્ટેડ છે.",
    fasterThanLight: "પ્રકાશ કરતાં ઝડપી",
    fasterThanLightDesc: "ઇન્ટરેક્ટિવ અવકાશી નકશા અને વરસાદની આગાહીઓ તરત જ લોડ થાય છે.",
    keepLovedOnesSafe: "તમારા પ્રિયજનોને સુરક્ષિત રાખો",
    keepLovedOnesSafeDesc: "સ્થાનિક ભાષાઓમાં હવામાન ચેતવણીઓ અને વીજળીની ચેતવણીઓ મેળવો.",
  },
};

export function Features() {
  const { language } = useLanguage();
  const f = featuresTranslations[language] || featuresTranslations.en;

  return (
    <section id="feature" className="py-16 md:py-32 dark:bg-transparent">
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        <div className="relative">
          ...
          >
            ...
            >
              <Card className="h-full flex justify-center overflow-hidden">
